    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="post/update.php" enctype="multipart/form-data">
          <input type="hidden" name="uid" class="id">
          <input type="hidden" name="dp_name" class="dp_name">
          <input type="text" name="title" placeholder="Enter Title" class="form-control etitle"><br>
          <textarea name="description" placeholder="What's on your mind?" class="form-control edescription"></textarea><br>
          <button type="button" class="btn btn-warning btn-sm pd_btn">PhotoDelete</button>
          <img src="" class="w-100 ephoto">
          <b>Photo : </b><input type="file" name="photo">
      </div>
      <div class="modal-footer">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="POST" action="mail.php">
          <input type="text" name="toemail" placeholder="To:" class="form-control mb-2 tomail" readonly>
          <input type="text" name="fromemail" placeholder="From" class="form-control mb-2" value="<?php echo $user['email'];?>">
