...
<ul class="list-group">
	<?php  
		...
		{
			$id=$_GET['id'];
			$start=($id-1)*$limit; //sa hmat ma pr 
		}
		else{
			$id=1; //for address bar 
		}
		...
		{ ?>
			<li class="list-group-item">
			  	...
			  	<button class="btn btn-outline-dark btn-sm mbtn" data-toggle="modal" data-target="#mail_Modal" toemail="<?php echo $friend_list['email']; ?>"><i class="fas fa-envelope-open-text" ></i> Mail</button>
			  	</div>
			</li>
		<?php } ?>
